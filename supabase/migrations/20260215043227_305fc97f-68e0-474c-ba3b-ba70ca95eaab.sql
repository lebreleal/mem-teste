...
DROP FUNCTION IF EXISTS public.admin_get_user_token_usage(uuid, integer);

CREATE FUNCTION public.admin_get_user_token_usage(p_user_id uuid, p_days integer DEFAULT 30)
