...
-- Add forecast_view preference to profiles
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS forecast_view text NOT NULL DEFAULT '7d';

-- Create RPC get_forecast_params
