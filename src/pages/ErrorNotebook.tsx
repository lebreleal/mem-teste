...
const ConceptRow = ({
  ...
  return (
    <div className="rounded-xl border border-border/50 bg-card px-4 py-3 space-y-2.5">
        ...
        <div className="container mx-auto flex items-center gap-3 px-4 py-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground">
              {weakConcepts.length} {weakConcepts.length === 1 ? 'conceito fraco' : 'conceitos fracos'} com erros
            </p>
          </div>
        </div>
      </header>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border py-16 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground max-w-xs">
              Não há conceitos fracos com erros. Continue estudando — conceitos fracos aparecerão aqui automaticamente.
            </p>
