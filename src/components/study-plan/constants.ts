...
export const HEALTH_CONFIG = {
  green: { ring: 'stroke-emerald-500', label: 'No Caminho', text: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20', icon: '✓' },
  yellow: { ring: 'stroke-amber-500', label: 'Atenção', text: 'text-amber-600 dark:text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/20', icon: '!' },
  orange: { ring: 'stroke-orange-500', label: 'Intenso', text: 'text-orange-600 dark:text-orange-400', bg: 'bg-orange-500/10', border: 'border-orange-500/20', icon: '!!' },
  red: { ring: 'stroke-red-500', label: 'Em Risco', text: 'text-red-600 dark:text-red-400', bg: 'bg-red-500/10', border: 'border-red-500/20', icon: '⚠' },
} as const;
