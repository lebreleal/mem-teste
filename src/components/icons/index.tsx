...
/* ─── Folder (Matéria) ─── */
export const IconFolder = ({ className = 'h-5 w-5' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className}>
    <path stroke="currentColor" strokeLinejoin="round" strokeWidth="2" d="M11.293 7.207A1 1 0 0 0 12 7.5h7a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-12a1 1 0 0 1 1-1h4.172a1 1 0 0 1 .707.293z" />
  </svg>
);

/* ─── Deck (Baralho) ─── */
export const IconDeck = ({ className = 'h-5 w-5', solid }: IconProps & { solid?: boolean }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className={className}>
    <path fill="currentColor" fillRule={solid ? 'nonzero' : 'evenodd'} d="m18.456 4.401-4.672-1.265A3.4 3.4 0 0 0 10.5 4H5.75A2.75 2.75 0 0 0 3 6.75v7.75c0 2.346 0 3.518.62 4.326a3 3 0 0 0 .554.554c.808.62 1.98.62 4.326.62.678 0 1.258 0 1.76-.015.409.125.879.252 1.41.396l.082.023c.795.215 1.451.392 1.997.492.567.104 1.103.142 1.646.022a3.97 3.97 0 0 0 2.065-1.192c.376-.41.61-.893.804-1.436.187-.523.36-1.18.572-1.976L20.88 8.6a3.44 3.44 0 0 0-2.425-4.2m-6.92 1.67a1.41 1.41 0 0 1 1.735-1.002l4.673 1.265a1.43 1.43 0 0 1 1.007 1.744l-2.035 7.672c-.224.847-.378 1.423-.533 1.858-.15.423-.275.626-.396.758-.275.3-.635.508-1.033.596-.175.04-.413.045-.855-.036-.454-.083-1.029-.238-1.875-.467s-1.42-.385-1.855-.543c-.423-.153-.626-.278-.758-.4-.3-.277-.51-.64-.6-1.038-.039-.176-.046-.415.033-.857.08-.455.233-1.031.457-1.878z" clipRule={solid ? 'nonzero' : 'evenodd'} />
  </svg>
);

/* ─── Edit (Lápis) ─── */
export const IconEdit = ({ className = 'h-5 w-5' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className={className}>
...
/* ─── Globe / World ─── */
export const IconGlobe = ({ className = 'h-5 w-5' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className={className}>
