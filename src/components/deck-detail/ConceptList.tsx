...
import { Brain, Lightbulb, CheckCircle2, MoreVertical, Pencil, Trash2, Layers, ChevronDown, ChevronUp, Search, RotateCcw, BookOpen } from 'lucide-react';
...
const stateLabel = (state: number) => {
  switch (state) {
    ...
    case 1: case 3: return { label: 'Aprendendo', icon: Brain, color: 'text-orange-500' };
